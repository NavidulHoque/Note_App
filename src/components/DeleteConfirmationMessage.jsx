...
const DeleteConfirmationMessage = ({DeleteConfirmationMessageState}) => {
  ...
  return (
    <div className={`fixed w-full top-0 left-0 h-[735px] justify-center items-center bg-[rgba(255,255,255,0.9)] ${DeleteConfirmationMessageState ? 'flex z-10' : "hidden -z-10"}`}>
      
      <div className='basis-[300px] bg-white shadow-md flex flex-col items-center gap-y-3 relative px-[15px] py-[24px] min-w-[300px]'>
        ...
        <h3 className="text-[20px]">Are You Sure?</h3>

        <p className="text-[15px] text-slate-400 text-center">Do you really want to delete these records? This process cannot be undone</p>

        <div className="w-full flex gap-x-2">

          <button onClick={() => dispatch(toggleDeleteConfirmationMessage())} className="w-[50%] text-[20px] py-[5px] bg-[rgb(50,50,50)] hover:bg-black text-white">No</button>
